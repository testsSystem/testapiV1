...
//   const result = await submitStudentsAnswer.bulkCreate(req.body);

//   if (result) {
//     return response.success(result, res);
//   } else {
//     return response.failedWithMessage("failed", res);
//   }
// };

// exports.sumitTet = async (req, res) => {
