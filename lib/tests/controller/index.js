...
exports.createTest = async (req, res, nex) => {
  ...
  //   console.log(result.dataValues.id, "ffffffffffffffffffff");
  //   const options = await models.Answers_options.bulkCreate([
  //     { answer: req.body.answer1, question_id, correctAnswer: false },
  //     { answer: req.body.answer2, question_id, correctAnswer: false },
  //     { answer: req.body.answer3, question_id, correctAnswer: true },
  //     { answer: req.body.answer4, question_id, correctAnswer: false },
  //   ]);
  //   if (options) {
  //     response.data = ;
  //     response.seccusss = true;
...
exports.createOptions = async (req, res, nex) => {
  ...
  const result = await models.Answers_options.bulkCreate([
    {
