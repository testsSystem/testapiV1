...
exports.endSession = async (req, res, nex) => {
  ...
  console.log(result.test_id, "resultttttttttttttttt");
  ...
  console.log(updatedAnswers, "uuuuuuuuupppppppp");
  ...
  let finalUpdate = updatedAnswers.map((ans) => {
    ...
    console.log(answerIndex, "aaaaaaaaaaaaa");
  ...
  console.log(questionsCount, "qqqqqqqqqqqq");
  if (result) {
